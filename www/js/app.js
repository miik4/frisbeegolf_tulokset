 ...
 * Kaikki tiedot on tietokannassa ja haetaan webservicen avulla (PHP, json). radat ja omattulokset taulujen välillä on relaatio.
 ...
 * Ratoja voi aina lisäillä sitä mukaan kun käy uusilla radoilla heittämässä.
 * Ohjelmaa olisi mahdollista viedä eteenpäin tekemällä "realiaikainen" laskuri, mihin kirjattaisiin väylä kohtaisesti tulokset, 
 * millä radalla ollaankaan ko. hetkellä heittämässä. Tällöin tasoitustilannettakaan ei tarvitsisi pitää mielessään ja jälkikäteen näkisi väylä kohtaisesti miten heitot ovat menneet.
 */
...
//------------------------------Funktiot----------------------------------------
    ...
    $scope.lisaaTulos = function () {
        ...
        $scope.dialogiData = [];
        $scope.dialogiData.uusiTulosRata = $scope.radat[0];//oletuksena selectissä ensimmainen rata mikä kannasta haettu
